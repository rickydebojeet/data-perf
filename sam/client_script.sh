...
echo "deviceIORate,cpu,memory,conns,arrivalRate,ioLoad,cpuLoad,responseTime" > loadtest.csv

for device_io in "50mb" "25mb"
do
    for cpu in 1 2 4
    do
        for mem in '700m' '800m' '900m' '1g'
        do 
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            awk -v var0="$device_io" -v var1="$cpu" -v var2="$mem" -v var3="$conns" -v var4="$rate" -v var5="$io" -v var6="$cpuLoad" '{OFS=","; if ($1 == "Reply" && $2 == "time") r1 = $5;} END{print var0,var1,var2,var3,var4,var5,var6,r1}' result.txt >> loadtest.csv
                            sleep 10
